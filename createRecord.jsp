    ...
    <body>
        ...
        <form action="create" method="get">
            ...
            Email: <input type="email" name="email" size="30"  
                          placeholder="Enter rater's email here." required>
            <br><br>
            
            <!-- Used the new HTML5 number type to force the user to enter a number.-->
            Rating: <input type="number" name="bloodsugar" size="30" placeholder="Scale of 1 to 10, 10 being the best." required>
            <br><br>
            
Book Title: <input type="text" name="bookTitle" size="30" required>
            <br><br>


            Rate Date: <input type="text" name="date" id="datepicker"  size="30">
            <br><br>
